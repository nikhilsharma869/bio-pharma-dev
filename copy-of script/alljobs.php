...

{
	...
	?><a href="bid.php?id=<?php print base64_encode($row['id']);?>"><input type="button" name="bid" id="bid" value="<?=$lang['Bid']?>" class="submit_bott" /></a><?php
	...
	?><input type="button" name="bid" id="bid" value="<?=$lang['Bid']?>" class="submit_bott1"  /><?php
...
{	 
 ...
 <tr>
	...
	<div align="center" style="color:#999999; font-size:12px;"><?=$lang['NO_JOB_FOUND']?></div>
