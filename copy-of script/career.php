...
if($_SESSION[lang_id]){
 ...
 $r = mysql_fetch_array(mysql_query("select * from ".$prev."contents "));
	$row_content=mysql_fetch_array(mysql_query("select * from ".$prev."contents where cont_title='".$current_page."'"));
}
