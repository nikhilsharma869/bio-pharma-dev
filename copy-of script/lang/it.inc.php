...
/*29_08
'MY_JOB_POSTED_H' => "My Posted  Jobs",
'OPEN_H' => "Open",
'CLOSE_H' => " Close",
'JB_DEL_H' => "Jobs Delivered",
'CLS_JB_H' => "Close Job ",
'JB_MSG1_H' => "Are you sure you want to close the project named",
'JB_MSG2_H' => "Caution: Provider will not be able to bid on the project anymore, and you won\'t be able to pick a Freelance.",
'JB_MSG3_H' => "Yes, Close it!",
'JB_MSG4_H' => "You also will NOT be able to re-open this project, it will be archived for reference.",
'EXTD_JB_H' => "Extent Job",
'N_2_H' => "2",
'NO_JB_H' => "No project of yours was found with the specified ID number.",
*/
...
'BID_ACCPT' =>"Bid accepted for the project",
...
'MSG_JOB_4' => "has been notified of your selection, and the project named",
'MSG_JOB_5' => "has been frozen temporarily.You will be e-mailed when they accept (or decline) the offer.",
'MSG_JOB_6' => "You can choose a new provider anytime if",
'MSG_JOB_7' => "does not respond.",
'MSG_JOB_8' => "If you do choose an alternate Web Developer, only the new provider will be able to accept your project offer.",
//End
//HASIBUL_30_08
...
'ZIP_RAR_H' => "File must be zip or rar.",
'AUTHOR_H' => "Author",
