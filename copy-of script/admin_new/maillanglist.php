                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <h4>&nbsp;
                                    <a href="mailsetup.php" class="header">Language List for <?=$_GET['type']?> mail templet</a>
                                            ...
                                            <table id="table-content" width="100%" class="sort-table" border="0" cellspacing="1" cellpadding="4">
                                                ...
                                                <thead>
                                                    ...
                                                    <tr bgcolor="<?= $graywhite2 ?>">
                                                        <td height="25" width="75%" align="left"><b>Language</b></td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    $main_query = "SELECT * FROM `" . $prev . "language` WHERE `status`='Y'";
                                                    ...
                                                    if (@mysql_num_rows($main_exe)) {
                                                        ...
                                                        while ($main_fetch = mysql_fetch_array($main_exe)) {
                                                            ...
                                                            <tr bgcolor="#ffffff" class="<?= $class ?>">
                                                                ...
                                                                <td align="left"><?php echo stripslashes($main_fetch['lang_name']); ?></td>

                                                                <td align="center">

                                                                    <a class="lnk" href="mailform.php?langid=<?php echo $main_fetch['short_code']; ?>&type=<?=$_GET['type']?>"><?php echo $main_icon_edit_img; ?></a></td>
