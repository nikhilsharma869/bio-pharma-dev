                                            ...
                                            <table id="table-content" width="100%" class="sort-table" border="0" cellspacing="1" cellpadding="4">
                                                ...
                                                <thead>
                                                    ...
                                                    <tr bgcolor="<?= $graywhite2 ?>">
                                                        ...
                                                        <td height="25" width="5%" align="left"><b>Sl No</b></td>
                                                ...
                                                <tbody>
                                                    ...
                                                    $total_exe = mysql_query("SELECT DISTINCT `mail_type` FROM " . $prev . "mailtemplet " . $where_clause . "");
                                                        ...
                                                        while ($main_fetch = mysql_fetch_array($main_exe)) {
                                                            ...
                                                            <tr bgcolor="#ffffff" class="<?= $class ?>">
                                                                ...
                                                                <td align="center">
                                                                    ...
                                                                    <a class='lnk tip' title='Edit Mail Template' href="maillanglist.php?type=<?php echo $main_fetch['mail_type']; ?>"><?php echo $main_icon_edit_img; ?></a></td>
