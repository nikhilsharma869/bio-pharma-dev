...

{
		...
		?>
		  ...
		  <tr class="<?php echo $ca;?>">
			...
			<td class="sm bdn space" > <div class="featured_img_bott"></div><p><a href="<?=$vpath?>project-dtl.php?id=<?php print $row[id];?>" style="text-decoration:none; color:#a1282c;"><?php echo $row['project'];?></a><?php echo $fjobs;?></p><p><img src="images/user.png" style="padding-right:3px;" /><span><?=ucwords(getusername($row["user_id"]));?> | <img src="images/budget.png" style="padding-right:3px;" /> Budget : <?=$budget_array[$row[budget_id]]?></span></p> </td>

			<td align="center" class="tdm" ><?php echo $num_bids;?> </td>
	...
	?><input type="button" name="bid" id="bid" value="Bid" class="submit_bott1" style="margin-left:30px;"  /><?php
