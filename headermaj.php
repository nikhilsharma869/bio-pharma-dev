            ...
            <li>
				...
				<div id="access_1">       
					<div class="menu_1">
						...
						<li class="last"><a <?php if($cur_page=="view_faq.php" || $cur_page=="contact_us.php") echo 'class="select"'; ?> href="javascript:void(0);" >BESOIN D'AIDE?</a>
							<ul>
                            <li><a href="<?=$vpath;?>howitworks.html">MODE D'EMPLOI</a></li>
								 <li><a href="<?=$vpath;?>view_faq.html">FAQ</a></li>
								 <li><a href="<?=$vpath;?>contact_us.html">Contact Us</a></li>
							</ul>
						</li>
   
   <li><a <?php if($cur_page=="sear_all_jobs.php" || $cur_page=="sear_all_jobs.php" || $cur_page=="sear_all_jobs.php" || $cur_page=="category.php") echo 'class="select"'; ?> href="<?=$vpath;?>dashboard.html">MON COMPTE</a>
							<ul>
                            
                             <li><a href="<?=$vpath;?>dashboard.html">Tableau de bord</a></li>
								 <li><a href="<?=$vpath;?>message.html">Messagerie</a></li>
								 <li><a href="<?=$vpath;?>profile.html">Modifier profil</a></li>
