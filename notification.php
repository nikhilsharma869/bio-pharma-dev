...
<?php include 'includes/dashboard_menu.php';?>
    ...
    <!--middle -->
<?php
		 $res_notification = mysql_query("select * from ".$prev."notification where user_id='".$_SESSION['user_id']."' AND (type ='".$_SESSION['user_type']."' OR type='B' )  order by add_date desc LIMIT $start, $limit");
