<?php $current_page="Register form client"; ?>
<?php ob_start();?>
<?php
...
<div class="page_headding">
	<h3 lang="en">Create account as a client</h3>
    <div class="clear"></div>
    <div class="click_panel"><span lang="en">Do you want to Sign up as a Freelancer</span>? <a href="register-form-work.html"><span lang="en">Click here</span></a></div>
</div>
<div class="sign_pane">
...
<div class="register-form"><p><span lang="en">Username</span>:</p>
...
<div class="register-form">
 ...
 <a href="info.html?id=32"><span lang="en"> privacy policy</span></a><span lang="en"> and user agreement</span>
  </h1>
  </form>
</div>
...
<div class="register-right">
  <h1>"<span lang="en">Now its easier then ever to get things done</span>!</h1>
</div>
<!--Register Right End-->
</div>
