        ...
        <div class="inner-middle"> 
            ...
            <div class="profile_left contracts_left">
                ...
                <ul id="up-tabs" class="nav nav-tabs" role="tablist">
                    ...
                    <li class="active"><a href="http://bio-pharma.dev/postjob.html">Tax Information</a></li>
            ...
            <div class="profile_right">
                ...
                <div class="content-right">    
                    <div class="userseting-getPaid">                
                        <div class="p-row">
                            <p class="left-box text-bold">Legal Name</p>
                            <p class="right-box">------</p>
                        </div>
                        <div class="p-row">
                            <p class="left-box text-bold">Address</p>
                            <p class="right-box">65 F Llamas Street<br/>Labangon, Cebu City<br/>6000 Philippines</p>
                        </div>
                        <div class="p-row">
                            <p class="left-box text-bold">Filing Status</p>
                            <p class="right-box">No Filing - Non-US</p>                        
                        </div>                        
                    </div>
                </div>
            </div>
