...
$r = mysql_query("select * from " . $prev . "disputes where resolve='Y'");
...
?>
    ...
    <div class="main">
		...
		$r=mysql_query("select count(*) as total from ".$prev."disputes where resolve='Y'");
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <h4>&nbsp;
									<a href="close_dispute.php" class="header">Close Dispute</a>&nbsp;&nbsp;&nbsp; (<?=$total?>)
									<?php if($msg) { echo $msg; }?>
									</h4> 
...
<form method=post action="<?=$_SERVER['PHP_SELF']?>">
  ...
  <p class="lnk" align="right"> <?php echo $main_icon_del_img; ?>&nbsp;= Delete </p>
  <table id="table-1" width="100%" border="0" align="center" cellspacing="1" cellpadding="4"  class="table table-striped table-bordered table-hover" id="dataTable">
    ...
    <tbody>
      <?php
	$r=mysql_query("select * from " . $prev . "disputes where resolve='Y' order by disput_id desc limit ".($page-1)*10 .", 10");
	...
	while($d=@mysql_fetch_array($r)):
		...
		echo"<tr  class=" . $class . ">
			...
			<td>" . substr($r4['project'],0,70) . "...</td>
			
	
			<td align=left>" . $r2['fname'] . " " . $r2['lname'] . "</td>
			
			<td align=left>" . $r3['fname'] . " " . $r3['lname'] . "</td>
			
			<td align=center>" . $status . "</td>
			
			<td align=center><a class='lnk tip' title='Delete Close Dispute'  href=\"javascript:if(confirm('Do you really want to delete the project?')){window.location='" . $_SERVER['PHP_SELF'] . "?id=" . $d[disput_id] . "&del=1';}\"><img src='images/icon_del.png' alt='Delete' width='16' height='16' border='0'></a></td></tr>";
			$j++;			
	endwhile;
	}
