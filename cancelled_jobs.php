...
$cur_child_menu = "cancelled_project";
    ...
    <div class="main_div2">
        <div class="inner-middle"> 
            ...
            <div class="profile_right">
					...
					$res21=mysql_query("SELECT * FROM " . $prev . "projects WHERE user_id='" . $_SESSION[user_id] . "' and status='cancelled' ORDER BY id,date2 DESC");
					$total =@mysql_num_rows($res21);

					$tinyres = mysql_query("SELECT * FROM " . $prev . "projects WHERE user_id='" . $_SESSION[user_id] . "' and status='cancelled' ORDER BY id,date2 DESC limit " . ($_REQUEST['page']-1)* $no_of_records. ",".$no_of_records."");
