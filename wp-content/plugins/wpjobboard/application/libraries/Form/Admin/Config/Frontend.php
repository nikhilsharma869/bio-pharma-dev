...
class Wpjb_Form_Admin_Config_Frontend extends Daq_Form_Abstract
{
    ...
    public function init()
    {
        ...
        $e = new Daq_Form_Element("front_hide_apply_link", Daq_Form_Element::TYPE_CHECKBOX);
        $e->setValue($instance->getConfig("front_hide_apply_link"));
        $e->setLabel(__("Apply online", WPJB_DOMAIN));
        $e->addOption(1, 1, __("Hide 'Apply Online' link on job details page.", WPJB_DOMAIN));
        $this->addElement($e);
