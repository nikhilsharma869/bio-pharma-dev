...
<table cellspacing="0" class="widefat post fixed">
    ...
    <<?php echo $tx; ?>>
        <tr>
            ...
            <th style="" class="column-icon" scope="col"><?php _e("Paid", WPJB_DOMAIN) ?></th>
            <th style="" class="" scope="col"><?php _e("Action", WPJB_DOMAIN) ?></th>
        </tr>
    </<?php echo $tx; ?>>
    <?php endforeach; ?>
	...
	<tr valign="top" class="<?php if($i%2==0): ?>alternate <?php endif; ?>  author-self status-publish iedit">
            ...
            <td class="">
                <?php if($item->made_at == "0000-00-00 00:00:00"): ?>
                -
                <?php else: ?>
                <?php echo date("Y-m-d", strtotime($item->made_at)) ?>
                <?php endif; ?>
            </td>
            <td class="">
            ...
            <td class="post-title column-title">
                ...
                <a href="<?php echo $this->_url->linkTo("wpjb/job", "edit/id/".$item->object_id); ?>" ><?php _e("Job Posting", WPJB_DOMAIN) ?>#<?php echo esc_html($item->object_id) ?></a>
            ...
            <td class="tags column-tags"><a href="<?php echo $this->_url->linkTo("wpjb/payment", "index/paid/".$item->id); ?>" class="button"><?php _e("Mark as Paid", WPJB_DOMAIN) ?></a></td>
        </tr>
    <?php endforeach; ?>
    </tbody>
</table>
