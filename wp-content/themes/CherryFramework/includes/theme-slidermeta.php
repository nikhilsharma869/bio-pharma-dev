...
$meta_box_slider = array(
	...
	'title' =>  __('Slider Options', 'cherry'),
	'page' => 'slider',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
    	array(
    	   'name' => __('Caption', 'cherry'),
    	   'desc' => __('Input your caption for slide (HTML tags are allowed). ', 'cherry'),
    	...
    	array(
    	   'name' => __('URL', 'cherry'),
    	   'desc' => __('Input the slide URL (can be external link)', 'cherry'),
...
function my_show_box_slider() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please fill additional fields for slide. ', 'cherry').'</p>';
