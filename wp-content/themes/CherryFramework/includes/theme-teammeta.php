...
$meta_box_team = array(
	'id' => 'my-meta-box-team',
	'title' =>  __('Personal Options', 'cherry'),
	'page' => 'team',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
    	array(
    	   'name' => __('Position', 'cherry'),
    	   'desc' => __('Input position of the person.', 'cherry'),
    	   'id' => $prefix . 'team_pos',
    	   'type' => 'text',
    	   'std' => ''
    	),
			array(
    	   'name' => __('Info', 'cherry'),
    	   'desc' => __('Input additional info.', 'cherry'),
    	   'id' => $prefix . 'team_info',
    	   'type' => 'text',
    	   'std' => ''
    	)
...
function my_show_box_team() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Please fill additional fields for person. ', 'cherry').'</p>';
