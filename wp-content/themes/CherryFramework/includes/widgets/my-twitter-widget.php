...
class MY_TwitterWidget extends WP_Widget {
    ...
    function MY_TwitterWidget() {
        parent::WP_Widget(false, $name = 'Cherry - Twitter');
    }
...
<div id="twitter-<?php echo $suf; ?>" class="twitter"></div>
    ...
    function form($instance) {
      ...
      $defaults = array( 'title' => '', 'twitter_name' => '', 'twitts_amount' => '' );
    ...
    ?>
      ...
      <p><label for="<?php echo $this->get_field_id('twitter_name'); ?>"><?php _e('Twitter Name:', 'cherry'); ?> <input class="widefat" id="<?php echo $this->get_field_id('twitter_name'); ?>" name="<?php echo $this->get_field_name('twitter_name'); ?>" type="text" value="<?php echo $twitter_name; ?>" /></label></p>
      <p><label for="<?php echo $this->get_field_id('twitts_amount'); ?>"><?php _e('Twitts Number:', 'cherry'); ?> <input class="widefat" id="<?php echo $this->get_field_id('twitts_amount'); ?>" name="<?php echo $this->get_field_name('twitts_amount'); ?>" type="text" value="<?php echo $amount; ?>" /></label></p>			
        <?php 
    }
} // class  Widget
?>