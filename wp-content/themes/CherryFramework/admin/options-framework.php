...
if ( !function_exists( 'optionsframework_add_subpage1' ) ) {
	function optionsframework_add_subpage1 () {
		$of_page = add_submenu_page('options-framework', 'Cherry Templates', 'Cherry Templates', 'administrator', 'options-framework-tmpls',  'admin_screen_tmpls');		
	}
}
...
?>
	...
	<div id="optionsframework-wrap" class="wrap">
		...
		<div class="extern-links">
			<a class="icon-a icon-support" href='http://info.template-help.com/help/cms-blog-templates/wordpress/wordpress-tutorials/' ><span class="icon"><span>Support</span></span></a>
			<a class="icon-a icon-documentation" href='http://info.template-help.com/help/wordpress-quick-start-guide.html' ><span class="icon"><span>Documentation</span></span></a>
		</div>
		<div class="clear"></div>
...
if ( ! function_exists( 'admin_screen_tmpls' ) ) {
	function admin_screen_tmpls () { ?>
		<div class="wrap">
			<p><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/admin/images/cherry-bnr.png" alt=""></a></p>
		</div><!--/.wrap-->
	<?php	
	}
}