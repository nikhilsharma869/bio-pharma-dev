		...
		<div class="row">			
			<div id="content" class="span8 <?php echo of_get_option('blog_sidebar_pos') ?>">
				...
				<div class="post-author post-author__page clearfix">
					<h1 class="post-author_h"><?php _e('About:', 'cherry'); ?> <small><?php echo $curauth->display_name; ?></small></h1>
				...
				<div id="recent-author-posts">
					<h3><?php _e('Recent Posts by', 'cherry'); ?> <?php echo $curauth->display_name; ?></h3>
					...
					if (have_posts()) : while (have_posts()) : the_post(); 
					 ...
					 <div class="no-results">
						<?php echo '<p><strong>' . __('No post yet.', 'cherry') . '</strong></p>'; ?>
					</div><!--no-results-->
			  ...
			  <div id="recent-author-comments">
				<h3><?php _e('Recent Comments by', 'cherry'); ?> <?php echo $curauth->display_name; ?></h3>
				  <?php
				  ...
				  <ul>
					<?php
					  ...
					  echo  '<li class="recentcomments">' . sprintf(__('%1$s on %2$s', 'cherry'), get_comment_date(), '<a href="'. get_comment_link($comment->comment_ID) . '">' . get_the_title($comment->comment_post_ID) . '</a>') . '</li>';
					endforeach; else: ?>
							  <p>
								<?php _e('No comments by', 'cherry'); ?> <?php echo $curauth->display_name; ?> <?php _e('yet.', 'cherry'); ?>
							  </p>
					<?php endif; ?>
						</ul>
