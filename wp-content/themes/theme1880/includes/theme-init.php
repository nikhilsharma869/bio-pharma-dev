...
function my_post_type_portfolio() {
	register_post_type( 'portfolio',
                array( 
				'label' => __('Portfolio', 'my_framework'), 
				'singular_label' => __('Porfolio Item', 'my_framework'),
				'_builtin' => false,
				'public' => true, 
				'show_ui' => true,
...
function my_post_type_testi() {
	register_post_type( 'testi',
                array( 
				'label' => __('Testimonial', 'my_framework'), 
				'public' => true, 
				'show_ui' => true,
				'show_in_nav_menus' => false,
				'menu_position' => 5,
...
function my_post_type_services() {
	register_post_type( 'services',
                array( 
				'label' => __('Services', 'my_framework'), 
				'public' => true, 
				'show_ui' => true,
				'show_in_nav_menus' => false,
				'menu_position' => 5,
...
function phi_post_type_faq() {
	register_post_type('faq', 
				array(
				'label' => __('FAQs', 'my_framework'),
				'singular_label' => __('FAQ', 'my_framework'),
				'public' => false,
				'show_ui' => true,
...
function my_post_type_team() {
	register_post_type( 'team',
                array( 
				'label' => __('Our Team', 'my_framework'), 
				'singular_label' => __('Person', 'my_framework'),
				'_builtin' => false,
				'exclude_from_search' => true, // Exclude from Search Results
				'capability_type' => 'page',
				'public' => true, 
